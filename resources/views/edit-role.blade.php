                        ...
                        <form action="{{ route('update-role', $role->id) }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="nama_role" class="form-control">
                                    ...
                                    <option value="admin" {{ $role->nama_role == 'admin' ? 'selected' : '' }}>Admin</option>
                                    <option value="operator" {{ $role->nama_role == 'operator' ? 'selected' : '' }}>Operator</option>
                                    <option value="dosen" {{ $role->nama_role == 'dosen' ? 'selected' : '' }}>Dosen</option>
                                    <option value="mahasiswa" {{ $role->nama_role == 'mahasiswa' ? 'selected' : '' }}>Mahasiswa</option>
                                </select>
                            </div>
                            <div class="mb-3">
                                <label><i class="fas fa-info-circle mr-1"></i> Deskripsi</label>
                                <textarea name="deskripsi" class="form-control" rows="3">{{ $role->deskripsi }}</textarea>
                            </div>
                            <div class="mb-3">
