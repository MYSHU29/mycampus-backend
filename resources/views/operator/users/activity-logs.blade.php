    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container-fluid">
                <div class="row mb-4">
                    <div class="col-md-8">
                        <h1 class="h3 mb-2 text-gray-800">Activity Log - {{ $user->name }}</h1>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Aktivitas {{ $user->name }}</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">Tidak ada activity log</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
